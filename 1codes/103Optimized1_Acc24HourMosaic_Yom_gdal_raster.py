'''
20200611 ทำฝนสะสมราย24ชั่วโมง เวลาท้องถิ่น ใช้ผลการโมเสคจาก15นาที แบบราสเตอร์จากไฟล์ "095"
ปรับปรุงโค้ดจากไฟล์ "098,099" คำนึงค่า radar flare แล้วในการทำฝนสะสม

00:00+01+02+03+04+05+...+23 (มี96ไฟล์ ถ้า1ชั่วโมงมีการสแกน4ครั้ง) หมายความว่า ฝนสะสมย้อนหลัง24ชั่วโมงจาก 23:45
.
.
.
...
path_outp24hr='D:/tmp/PyQGIS/Plugin_practice/z_temp/1outp_mosaic_temp/mosaic_24h/' #เก็บผลลัพธ์ฝนสะสม24ชม.
...
for ymd in fymd:
    ...
    #ลูป 24 รอบใน 1 วัน
    for n in range(1): #1 คือ 24/24 สะสมฝนทุกๆ24ชม.
        print('ทำการสะสมฝนราย6ชั่วโมง...'+ymd)
        start=n*24
        stop=start+24
        
        files=[] #ลิสเก็บชื่อไฟล์ที่หาได้ในแต่ละชั่วโมงที่ต้องการ ในที่นี้ทีละ24ชั่วโมง
        for h in range(start,stop): #ลูป24ชั่วโมงที่ต้องการ
...
#        break    
        #สะสมฝนในรอบ 24 ชั่วโมงที่ต้องการ
        num_file=len(files)
        ...
        out_arr=np.zeros(data.shape,dtype=float) #ผลลัพธ์ที่จะเอาเก็บฝนสะสมราย24ชั่วโมง
        out_cnt=np.zeros(data.shape,dtype=float) #ผลลัพธ์ที่จะเอาเก็บตัวนับว่ามีฝนหรือไม่หรือมี flare จะกำหนดให้เป็น0
        
        filename=path_outp24hr+fileName #ไฟล์ที่เก็บผลลัพธ์ฝนสะสมราย24ชั่วโมง    
        ...
        for rr in range(num_file):
            ...
            out_cnt = out_cnt+(count_data/24) #สะสมตัวหาร    
            #count_data/24> หาร12หมายถึง มี24ชั่วโมงที่นำมาสะสม เมื่อนำมาหาร24จะทำให้กลายเป็นฝนสะสมราย24ชั่วโมง
        ...
        print('.'*30)
print('เสร็จสิ้นการสะสมฝนราย24ชั่วโมง.....')
