'''
20200613 การสกัดค่าฝนเรดาร์และฝนสถานีในแต่ละเวลา ราย15นาที ปรัับปรุงจากไฟล์112
...
path_rg='D:/tmp/PyQGIS/Plugin_practice/z_temp/1outp_gauge_temp/1gauge15min/'#โฟลเดอร์เก็บฝนสถานี15นาที
path_rr='D:/tmp/PyQGIS/Plugin_practice/z_temp/1outp_mosaic_temp/' #โฟลเดอร์เก็บฝนเรดาร์15นาที
path_val='D:/tmp/PyQGIS/Plugin_practice/z_temp/1outp_validation/1validate15min/' #โฟลเดอร์เก็บผลลัพธ์สกัดข้อมูลrg+rr
...
fileOutput='validate_rr_rg_15min.csv'
