'''
2020.05.29 หา radar flare กับ beamblock
ใช้โค้ดจากไฟล์ "057" และ "070"
1.คำนวนหา radarflare ก่อน สองรอบ
2.หา beamblock จากการผลลัพธ์ราสเตอร์ที่ได้ทำไว้ในโค้ด "068"
3.อัพเดทค่ารหัสคุณภาพเรดาร์คอลัมน์ RQI (0,1,2,3=ดี,flare,bb,flare+bb)

ต่อไปจะนำไปใช้กับเรดาร์เชียงราย
...
#-------------------------------------------------------------------------------
def radarFlareDetectionRound1(phLayer,PC_BinWithVal,Corr):
...
#        if i<10:print('angle:',ang)
    ...
    #    print(slope)
        ...
        for k,f in enumerate(phLayer.selectedFeatures()):
            ...
            phLayer.changeAttributeValue(f.id(),6,(ct/240)*100.0) #240 คือจำนวน bin ถ้า gatsize=1.0km
            ...
            if ((ct/240)*100.0)>=PC_BinWithVal and r_value>=Corr : 
...
phLayer = QgsVectorLayer(uri, 'rad_PHS_final', 'memory') #สร้าง instance ของชั้นข้อมูลเวกเตอร์ตาม uri
...
ptLayer = QgsVectorLayer(uri, 'point_rad_PHS', 'memory') #สร้าง instance ของชั้นข้อมูลเวกเตอร์ตาม uri
...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
#เริ่มกระบวนการสกัดค่า beamblock ที่เป็นผลจากไฟล์ "068"
#-------------------------------------------------------------------------------
...
path_to_beamblock = "D:/Yang/1Reseach/0.2563.RadarMosGISYomNan/2codes/3For_TMD/1data/BeamBlockPhitsanulokRadarRaster.tif"
rLayer = QgsRasterLayer(path_to_beamblock , "BeamBlock_PHS")
#-------------------------------------------------------------------------------
