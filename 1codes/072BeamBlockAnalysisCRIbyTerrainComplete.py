'''
20200530 การคำนวนการบดบังของบีมจากภูมิประเทศแบบสมบูรณ์ จะนำไปเป็นไฟล์ต้นแบบเพื่อทำ spatial intersect กับทุกการสแกน
การสร้างรูปปิดของเรดาร์ของมุมยกแรกในทุกอซิมุทและทุกระยะทางด้วยการคำนวน radius effective ตามระยะทางและมุมของเรดาร
ใช้ค่ามุมจากการอ่านไฟล์ต้นฉบับเพื่อให้ได้อซิมุทของเรดาร์เชียงราย แล้วนำมาหารสองกับมุมข้างเคียงเพื่อให้ได้ตรงกลางของแนวสแกน
...
import math
import numpy as np
print('คำนวนลำบีมที่ถูกภูมิประเทศบดบังโดยใช้โครงสร้างของเรดาร์จริงของเรดาร์เชียงราย.............')
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
#1.แปลงพิกัดสถานีเชียงรายจาก geo เป็น utm
...
ptLayer = QgsVectorLayer(uri, 'sta_rad_CRI', 'memory') #สร้าง instance ของชั้นข้อมูลเวกเตอร์ตาม uri
...
pLayer = QgsVectorLayer(uri, 'poly_beamblock_cri', 'memory') #สร้าง instance ของชั้นข้อมูลเวกเตอร์ตาม uri
...
rad_alt=387  # ความสูงสถานีจากระดับน้ำทะเลปานกลาง (เมตร)
#-------------------------------------------------------------------------------
...
ppLayer = QgsVectorLayer(path_to_rad_layer, "rad_pcri_utm201908041300", "ogr") #ค่าพิกัดชั้นข้อมูลที่จะใช้WGS84
...
path_to_DEM = "D:/Yang/1Reseach/0.2563.RadarMosGISYomNan/2codes/3For_TMD/1data/DEM_for_CRI_radar.tif"
rlayer = QgsRasterLayer(path_to_DEM, "DEM_CRI")
...
path_to_rad_layer = "D:/Yang/1Reseach/0.2563.RadarMosGISYomNan/2codes/3For_TMD/1data/BeamBlockChiangraiRadar.shp"
...
outp = "D:/Yang/1Reseach/0.2563.RadarMosGISYomNan/2codes/3For_TMD/1data/BeamBlockChiangraiRaster.tif"
...
'WIDTH':500,
'HEIGHT':500,
'EXTENT':'354574.0468551223,830043.4846529987,1969804.1230036665,2444802.16783399 [EPSG:32647]',
'NODATA':0,'OPTIONS':'',
'DATA_TYPE':5,
'INIT':None,
'INVERT':False,
