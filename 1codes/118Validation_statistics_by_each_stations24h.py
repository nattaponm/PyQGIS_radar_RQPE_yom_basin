'''
20200613 หาค่าสถิติ validation รายสถานี ราย24h ปรับปรุงโค้ดจาก 118 โดยข้อมูลจากไฟล์115
...
path_val='D:/tmp/PyQGIS/Plugin_practice/z_temp/1outp_validation/1validate24h/' 
...
fileOutput='validate_rr_rg_24h_each_stations.csv'
